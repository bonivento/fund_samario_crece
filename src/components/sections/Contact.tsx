  ...
  return (
    <section id="contacto" className="section-padding bg-white">
      <Container size="md">
        <SectionTitle
          title="Contáctanos"
          subtitle="¿Tienes preguntas o quieres colaborar con nosotros? Escríbenos"
        />
          ...
          >
            ...
            <div className="space-y-6">
              <div className="flex items-start gap-4">
                ...
                <div>
                  <h4 className="font-medium text-secondary">Ubicación</h4>
            ...
            {/* Social Links */}
            <div className="mt-8">
              <h4 className="font-medium text-secondary mb-4">Síguenos</h4>
